...
import WordModal from "./word-modal/WordModal.tsx";
import { wordsPairList } from "@/shared/types/wordDataTypes.ts";
...
const VideoPlayer = ({
  ...
  const playPronunciation = (accent: string) => {
    ...
    accent === "Am"
      ? AmericanAudioRef.current.play()
      : BritishAudioRef.current.play();
  };
  ///////////
