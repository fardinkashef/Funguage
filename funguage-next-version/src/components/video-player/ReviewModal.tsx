...
function ReviewModal({
  ...
  let databaseWords: databaseWord[] = wordsPairList.reduce(
    (accumulator: databaseWord[], currentPair: wordsPair) => [
      ...accumulator,
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const extractDatabaseWordListIds = (databaseWordList: databaseWord[]) =>
